...
#sshpass -p $SF_PW_MAPPED scp -o StrictHostKeyChecking=no ffmpeg-${SUFFIX}*.tar.xz $SF_USER_MAPPED,zero16832@frs.sourceforge.net:/home/frs/project/ffbuild/${TARGET_OS/mingw/windows-desktop}